"""
Verify and analyze YOLO format labels for semantic buildings dataset.
...
Usage:
    python verify_yolo_labels.py --labels-dir "../../datasets/semantic_buildings_in_aerial_imagery/train/labels" \\
                                 --images-dir "../../datasets/semantic_buildings_in_aerial_imagery/train/images" \\
                                 --class-dict "../../datasets/semantic_buildings_in_aerial_imagery/class_dict.csv"
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Verify and analyze YOLO format labels for semantic buildings dataset"
    )
    parser.add_argument(
        '--labels-dir',
        type=str,
        default='../../datasets/semantic_buildings_in_aerial_imagery/train/labels',
        help='Path to YOLO format label files'
    )
    parser.add_argument(
        '--images-dir',
        type=str,
        default='../../datasets/semantic_buildings_in_aerial_imagery/train/images',
        help='Path to images directory'
    )
    parser.add_argument(
        '--class-dict',
        type=str,
        default='../../datasets/semantic_buildings_in_aerial_imagery/class_dict.csv',

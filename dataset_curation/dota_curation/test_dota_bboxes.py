"""
Visualization script for DOTA dataset - displays sample images with bounding boxes
"""
import random
...
def visualize_dota_samples_with_bboxes(dataset_dir, num_samples=4, split='train'):
    """
    Visualize DOTA dataset samples with their bounding boxes
    
    Args:
        dataset_dir: Path to the DOTA dataset directory
...
if __name__ == "__main__":
    ...
    # Visualize 4 random samples from training split
    print(f"Visualizing DOTA dataset from {dataset_path}")
    print("=" * 60)
